        ...
        : error ? (<div className="alert alert-danger">{error}</div>)
          : summaryData && (
            <>
              ...
              {isEnabled('financeiro_analise_pagamentos') && (
              ...
              {/* ✅ Comparativo Mensal */}
              {isEnabled('financeiro_comparativo_mensal') && (
              ...
              {isEnabled('financeiro_comparativo_produto') && (
                <div className="card mt-4">
              ...
              <div className="row mt-4">
                ...
                {isEnabled('financeiro_top10_clientes') && (
                ...
                {isEnabled('financeiro_top10_produtos') && (
